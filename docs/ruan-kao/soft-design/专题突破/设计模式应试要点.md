...
> 下午常在 **UML 类图 / 场景描述** 中考 **GoF 模式识别与选型**。**23 种模式分类、每模式举例、三类快判** 见 **[UML与设计模式](/ruan-kao/soft-design/applied/uml-patterns.html)** §1.3；本文保留 **阅卷检查表 + 易混排除 + 意图速扫**，便于考前扫读。
...
完整 **举例 + 角色 + 题干关键词** → [UML与设计模式](/ruan-kao/soft-design/applied/uml-patterns.html) **§1.3**。
