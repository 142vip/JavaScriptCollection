import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o,c as e,a as n,b as a,d as c,e as u}from"./app-be253e4c.js";const l="/JavaScriptCollection/assets/findPath-8d5238f0.png",r={},i=n("h1",{id:"二叉树中和为某一值的路径-二",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#二叉树中和为某一值的路径-二","aria-hidden":"true"},"#"),a(" 二叉树中和为某一值的路径(二)")],-1),k=n("h2",{id:"题目链接",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#题目链接","aria-hidden":"true"},"#"),a(" 题目链接")],-1),d={href:"https://www.nowcoder.com/share/jump/8484115461699864980328",target:"_blank",rel:"noopener noreferrer"},h=u('<h2 id="题目描述" tabindex="-1"><a class="header-anchor" href="#题目描述" aria-hidden="true">#</a> 题目描述</h2><figure><img src="'+l+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="刷题思路" tabindex="-1"><a class="header-anchor" href="#刷题思路" aria-hidden="true">#</a> 刷题思路</h2><h2 id="代码实现" tabindex="-1"><a class="header-anchor" href="#代码实现" aria-hidden="true">#</a> 代码实现</h2><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/*
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="一些建议" tabindex="-1"><a class="header-anchor" href="#一些建议" aria-hidden="true">#</a> 一些建议</h2>`,6);function f(m,_){const s=p("ExternalLinkIcon");return o(),e("div",null,[i,k,n("ul",null,[n("li",null,[n("a",d,[a("牛客网"),c(s)])])]),h])}const x=t(r,[["render",f],["__file","find-path-sum.html.vue"]]);export{x as default};
